			...
			<div class="col-lg-3">
				...
				<ul class="list-unstyled templatemo-accordion">
					<li class="pb-3"><a
						...
						href="#"> 장르 <i class="fa fa-fw fa-chevron-circle-down mt-1"></i>
					</a>
						<ul class="collapse show list-unstyled pl-3">
							<c:forEach var="BookVO" items="${genreList}" varStatus="st">
								<li><a class="text-decoration-none"
									href="${ctx}/bookList.do?cate=genre&key=${BookVO.genre}">${BookVO.genre}</a></li>
							</c:forEach>
					...
					<li class="pb-3"><a
						...
						<ul id="collapseTwo" class="collapse list-unstyled pl-3">
							<c:forEach var="BookVO" items="${countryList}" varStatus="st">
								<li><a class="text-decoration-none"
									href="${ctx}/bookList.do?cate=country&key=${BookVO.country}">${BookVO.country}</a></li>
							</c:forEach>
						</ul></li>
					<li class="pb-3"><a
						class="collapsed d-flex justify-content-between h3 text-decoration-none"
						...
						<ul id="collapseThree" class="collapse list-unstyled pl-3">
							<c:forEach var="BookVO" items="${publisherList}" varStatus="st">
								<li><a class="text-decoration-none"
									href="${ctx}/bookList.do?cate=publisher&key=${BookVO.publisher}">${BookVO.publisher}</a></li>
							</c:forEach>
						</ul></li>
				</ul>
			</div>
					...
					<div class="col-md-6">
						<ul class="list-inline shop-top-menu pb-3 pt-1">
							<li class="list-inline-item"><a
								...
								href="${ctx}/bookList.do?show=letter">글자순</a></li>
							<li class="list-inline-item"><a
								class="h3 text-dark text-decoration-none mr-3"
								href="${ctx}/bookList.do?show=latest">최신순</a></li>
							<li class="list-inline-item"><a
								class="h3 text-dark text-decoration-none mr-3"
								href="${ctx}/bookList.do?show=sale">판매순</a></li>
							<li class="list-inline-item"><a
								class="h3 text-dark text-decoration-none mr-3"
								href="${ctx}/bookList.do?show=rating">평점순</a></li>	
									...
									<div
										...
										<ul class="list-unstyled">
											...
											<li><a class="btn btn-success text-white mt-2" href="#"
												onclick="cartAdd(${BookVO.isbn})" id="cartAddBtn"><i
								...
								<div class="card-body text-center mb-0">
									...
									<ul class="list-unstyled d-flex justify-content-center mb-1">
										<c:if test="${BookVO.rating <1 }">
											<li><i class="text-muted fa fa-star"></i> <i
